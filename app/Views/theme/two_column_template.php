...
<body>
    ...
    <div id="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <?= view_cell('App\Libraries\Blog::recentPostsWidget', 'limit=5') ?>
                    <?= view_cell('App\Libraries\Blog::popularPostsWidget', 'limit=5') ?>
                </div>
                <div class="col">
