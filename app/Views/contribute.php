<div class="container">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			...
			<p><em>Note: the two GitHub links above are for the CodeIgniter 3 repository.
				They will be replaced with the CodeIgniter 4 ones once it launches.</em></p>
		</div>
	</div>
			...
			<div class="bs-component">
				<div class="well download">
					...
					<p>CodeIgniter 4 has its own
						<a href="https://github.com/codeigniter4/CodeIgniter4" target="_blank">Github repository</a>.
						It deviates enough from CodeIgniter 3 that we want to keep them separate.
						The CodeIgniter 4 roadmap is explained on 
						<a href="http://forum.codeigniter.com/forum-28.html" target="_blank">our forum</a>, 
						and work to be done
						is detailed in the 
						<a href="https://github.com/codeigniter4/CodeIgniter4/issues" target="_blank">repository issues</a>.
					</p>
				</div>
			</div>
		</div>
				...
				<div class="well download">
					...
					<div class="list-group">
						<div class="list-group-item">
							...
							<p><em>CodeIgniter 4 has its own <a href="https://forum.codeigniter.com/forum-30.html">support subforum</a>.</em></p>
						</div>
						<div class="list-group-item">
							...
							<p><em>CodeIgniter 4's user guide is part of its own <a href="https://github.com/codeigniter4/CodeIgniter4">repository</a>.</em></p>
						</div>
						<div class="list-group-item">
				...
				<div class="well download">
					...
					<div class="list-group">
						<div class="list-group-item">
							...
							<p><em>CodeIgniter 4 equivalent links: its <a href="https://github.com/codeigniter4/CodeIgniter4">repository</a>,
								its <a href="https://github.com/codeigniter4/CodeIgniter4/tree/develop/contributing">contribution guide</a>,
								and its <a href="https://github.com/codeigniter4/CodeIgniter4/blob/develop/contributing/styleguide.rst">style</a>.</em></p>
						</div>
						<div class="list-group-item">
	...
	<div class="row">
		...
		<div class="col-md-12 col-sm-12">
			<div class="bs-component">
				<div class="well download">
					<h3>Acknowledging Our Top CodeIgniter 3 Contributors</h3>
					<div class="row">{fw_heros}</div>
					<hr/>
					<h3>Acknowledging Our Top CodeIgniter 3 Translation Contributors</h3>
					<div class="row">{trans_heros}</div>
					<br/>
					<h3>Acknowledging Our Top CodeIgniter4 Contributors</h3>
					<div class="row">{ci4_heros}</div>
					<hr/>
					<h3>Acknowledging Our Top CodeIgniter 4 Translation Contributors</h3>
