	...
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 text-center title">
			...
			<p>The primary documentation for CodeIgniter is its User Guide.<br/>
				The User Guide contains an introduction, tutorial, a number
		...
		<div class="col-md-6 col-sm-6">
			<div class="bs-component">
				<div class="well download">
					...
					<p>CodeIgniter 4.x is the upcoming version of the framework, 
						licensed under the <a href="https://github.com/codeigniter4/CodeIgniter4/blob/develop/license.txt">MIT License</a>.</p>
		...
		<div class="col-md-6 col-sm-6">
			<div class="bs-component">
				<div class="well download">
					...
					<p>CodeIgniter 3.x is the current version of the framework, 
						licensed under the <a href="/user_guide/license.html">MIT License</a>.</p>
