				...
				<div class="well download">
					...
					<ul class="nav nav-pills justify-content-center">
						<li class="nav-item" style="margin:0.5em;">
							<a class="nav-link btn-primary" href="{mybb_forum_url}"><i class="glyphicon glyphicon-share"></i> Visit the forum</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="col-md-6 col-sm-6">
			<div class="bs-component">
				<div class="well download">
					...
					<p>CodeIgniter has a Slack channel, where you can engage with 
						other members of the community. Anyone can 
						<a href="http://codeignitersignup.ciblox.com/">signup</a> for it :)
					</p>

					<ul class="nav nav-pills justify-content-center">
						<li class="nav-item" style="margin:0.5em;">
							<a class="nav-link btn-info" href="https://codeigniterchat.slack.com/" target="_blank">
								<i class="glyphicon glyphicon-share"></i> Visit Slack</a>
						</li>
					</ul>
				</div>
			</div>
